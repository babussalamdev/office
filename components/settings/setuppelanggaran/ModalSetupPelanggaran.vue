  ...
  <div>
    ...
    >
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <form
            @submit.prevent="inputDataPelanggaran"
            ref="inputDataPelanggaran"
          >
    ...
    >
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <form
            @submit.prevent="updateDataPelanggaran"
            ref="updateDataPelanggaran"
          >
            <div class="modal-header">
              <h1 class="modal-title fs-5" id="exampleModalLabel">
    ...
    async inputDataPelanggaran(event) {
      ...
      try {
        const result = await this.$axios.$post(
          `/input-database?subject=pelanggaran`,
          data
        );
        this.btn = true;
        Swal.fire({
    ...
    async updateDataPelanggaran(event) {
      ...
      try {
        ...
        const result = await this.$axios.$put(
          `update-database?subject=pelanggaran&program=${program}&code=${
            key.split("#")[1]
          }`,
          data
        );
        ...
        this.value = [];
        this.$store.commit("setuppelanggaran/updateStruktur", data);
