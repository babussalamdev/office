  ...
  <div>
      ...
      <div class="col-12 col-md-6">
        ...
        <div class="button-santri float-end">
          <button
            ...
            data-bs-target="#inputDataPelanggaran"
          >
            Tambah Data
          </button>
        </div>
    ...
    <div class="table-responsive animate__animated animate__fadeInUp">
      <table class="table table-hover table-striped">
        ...
        <tbody>
          <tr v-for="(data, i) in pelanggaran" :key="i">
    ...
    async deleteItem(key) {
      ...
      if (result.isConfirmed) {
        ...
        await this.$axios.$delete(
          `delete-database?subject=pelanggaran&program=${program}&code=${
            key.split("#")[1]
          }`
        );
        this.$store.commit("setuppelanggaran/deleteStruktur", key);
        if (result) {
          Swal.fire({
            position: "center",
            icon: "success",
