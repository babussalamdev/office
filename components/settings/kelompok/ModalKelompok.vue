<template>
  <div>
    ...
    <div class="modal fade" id="InputDataHalaqoh" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <form @submit.prevent="inputHalaqah" id="inputHalaqah">
            <div class="modal-header">
              <h1 class="modal-title fs-5" id="exampleModalLabel">Input Halaqoh</h1>
    ...
    <div class="modal fade" id="InputDataHalaqohIdhofi" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <form @submit.prevent="inputHalaqahIdhofi" id="inputHalaqahIdhofi">
            <div class="modal-header">
              <h1 class="modal-title fs-5" id="exampleModalLabel">Input Halaqoh</h1>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
    ...
    <div class="modal fade" id="InputDataAsrama" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <form @submit.prevent="inputAsrama" id="inputAsrama">
            <div class="modal-header">
              <h1 class="modal-title fs-5" id="exampleModalLabel">Input Asrama</h1>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              <div class="mb-3">
...
<script>
  ...
  export default {
    computed: {
      ...mapState("kelompok", ["btn"]),
    },
    methods: {
      ...mapActions("kelompok", ["inputHalaqah", "inputHalaqahIdhofi", "inputAsrama"]),
    },
  };
</script>
