<template>
  <div>
    <!-- input modal -->
    <div class="modal fade" id="inputDataQuranPenilaian" tabindex="-1" aria-labelledby="exampleModalLabel"
      aria-hidden="true">
...
export default {
  computed: {
    ...mapState('setupnilaiquran', ['updateDataPenilaian', 'btn'])
  },
  methods: {
    ...mapActions('setupnilaiquran', ['inputDataPenilaian'])
