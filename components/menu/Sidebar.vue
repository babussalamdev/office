    ...
    <div class="sidebar-container scrollarea">
      ...
      <nav class="menu">
        ...
        <ul>
          ...
          <!-- Absensi -->
          <li>
            <nuxt-link to="/absensi" class="text-decoration-none d-flex align-items-center gap-2">
              <i class="material-icons animate__animated animate__fadeInRight">
                checklist
              </i>
          ...
          <!-- Mutabaah -->
          <li>
            <div @click="mutabaah" class="dropdown d-flex align-items-center justify-content-between gap-2">
            ...
            <ul v-if="listMutabaah" class="dropdown-list">
              <li>
                <nuxt-link to="/mutabaah/rekaptahfidz"
                  class="custom-link text-decoration-none d-flex align-items-center gap-2">
                  <i class="material-icons animate__animated animate__fadeInRight">
                    summarize
                  </i>
                  <span class="text animate__animated animate__fadeInRight">Rekap Hafalan</span>
                </nuxt-link>
              </li>
            </ul>
          </li>
          <!-- Santri -->
          <li>
            <div @click="santri" class="dropdown d-flex align-items-center justify-content-between gap-2">
              <span class="d-flex align-items-center gap-2">
                <i class="material-icons animate__animated animate__fadeInRight">
                  account_box
                </i>
            ...
            <ul v-if="listSantri" class="dropdown-list">
              <li>
                <nuxt-link to="/santri/database"
                  ...
                  <span class="text animate__animated animate__fadeInRight">Database Santri</span>
                </nuxt-link>
              </li>
              <li>
                <nuxt-link to="/santri/kelas" class="text-decoration-none d-flex align-items-center gap-2">
                  <i class="material-icons animate__animated animate__fadeInRight">
                    school
                  </i>
              ...
              <li>
                <nuxt-link to="/santri/asrama" class="text-decoration-none d-flex align-items-center gap-2">
                  <i class="material-icons animate__animated animate__fadeInRight">
                    bedtime
                  </i>
              ...
              <li>
                <nuxt-link to="/santri/halaqoh" class="text-decoration-none d-flex align-items-center gap-2">
                  <i class="material-icons animate__animated animate__fadeInRight">
                    book
                  </i>
                  <span class="text animate__animated animate__fadeInRight">Halaqoh</span>
                </nuxt-link>
              </li>
              <li>
                <nuxt-link to="/santri/ekskull" class="text-decoration-none d-flex align-items-center gap-2">
                  <i class="material-icons animate__animated animate__fadeInRight">
                    sports_volleyball
                  </i>
          ...
          <!-- Pegawai -->
          <li>
            <div @click="pegawai" class="dropdown d-flex align-items-center justify-content-between gap-2">
              <span class="d-flex align-items-center gap-2">
                <i class="material-icons animate__animated animate__fadeInRight">
                  accessibility
                </i>
            ...
            <ul v-if="listPegawai" class="dropdown-list">
              ...
              <!-- wali kelas -->
              <li>
                <nuxt-link to="/pegawai/walas" class="custom-link text-decoration-none d-flex align-items-center gap-2">
                  <i class="material-icons animate__animated animate__fadeInRight">
                    face
                  </i>
              ...
              <!-- mapel -->
              <li>
                <nuxt-link to="/pegawai/mapel" class="custom-link text-decoration-none d-flex align-items-center gap-2">
                  <i class="material-icons animate__animated animate__fadeInRight">
                    auto_stories
                  </i>
          ...
          <!-- Settings -->
          <li>
            <div @click="settings" class="dropdown d-flex align-items-center justify-content-between gap-2">
              <span class="d-flex align-items-center gap-2">
                <i class="material-icons animate__animated animate__fadeInRight">
                  settings
                </i>
            ...
            <ul v-if="listSettings" class="dropdown-list">
              <!-- Utama -->
              <li>
                <nuxt-link to="/settings/periode" class="text-decoration-none d-flex align-items-center gap-2">
                  <i class="material-icons animate__animated animate__fadeInRight">
                    dns
                  </i>
              ...
              <!-- Kelompok -->
              <li>
                <nuxt-link to="/settings/kelompok" class="text-decoration-none d-flex align-items-center gap-2">
                  <i class="material-icons animate__animated animate__fadeInRight">
                    auto_stories
                  </i>
                  <span class="text animate__animated animate__fadeInRight">Kelompok</span>
                </nuxt-link>
              </li>
              <!-- Kelas -->
              <li>
                <nuxt-link to="/settings/kelas" class="text-decoration-none d-flex align-items-center gap-2">
                  <i class="material-icons animate__animated animate__fadeInRight">
                    school
                  </i>
                  <span class="text animate__animated animate__fadeInRight">Kelas</span>
              ...
              <!-- Mapel -->
              <li>
                <nuxt-link to="/settings/mapel" class="text-decoration-none d-flex align-items-center gap-2">
                  <i class="material-icons animate__animated animate__fadeInRight">
                    sticky_note_2
                  </i>
                  <span class="text animate__animated animate__fadeInRight">Mapel</span>
              ...
              <!-- Kaldik -->
              <li>
                <nuxt-link to="/settings/kaldik" class="text-decoration-none d-flex align-items-center gap-2">
                  <i class="material-icons animate__animated animate__fadeInRight">
                    edit_calendar
                  </i>
                  <span class="text animate__animated animate__fadeInRight">Kaldik</span>
              ...
              <!-- Struktur -->
              <li>
                <nuxt-link to="/settings/struktur" class="text-decoration-none d-flex align-items-center gap-2">
                  <i class="material-icons animate__animated animate__fadeInRight">
                    timeline
                  </i>
          ...
          <li>
            <nuxt-link to="/help" class="text-decoration-none d-flex align-items-center gap-2">
              ...
              <span class="text animate__animated animate__fadeInRight">Help</span>
            </nuxt-link>
          </li>
        </ul>
      </nav>
