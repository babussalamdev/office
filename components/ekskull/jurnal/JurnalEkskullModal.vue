          ...
          <form @submit.prevent="submit" id="modalInput">
            ...
            <div class="modal-body">
              <div class="form-floating mb-3">
                <textarea class="form-control" placeholder="Leave a comment here" id="judul" style="height: 100px" name="Description"></textarea>
                <label for="judul">Judul Pembahasan</label>
              </div>
              <div class="form-floating mb-3">
                <textarea class="form-control" placeholder="Leave a comment here" id="catatan" style="height: 100px" name="Occurrence"></textarea>
