<template>
  <div>
    <!-- Modal -->
    <div class="modal fade" id="modalAbsen" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <form @submit.prevent="santriAbsen" id="santriAbsen">
...
<script>
  ...
  export default {
    computed: {
      ...mapState("ekskullAbsensi", ["updateData", "btn"]),
    },
    methods: {
      ...mapActions("ekskullAbsensi", ["santriAbsen"]),
    },
  };
</script>
