          ...
          <tr v-for="(data, index) in santri" :key="index">
            ...
            <td v-for="(value, key) in data.Penilaian" :key="key">
              <div
                ...
                @click.prevent="setEdit(index, value, key)"
                class="cursor-pointer"
                :class="isNaN(value) ? 'text-danger' : ''">
                {{ value }}
              </div>
    ...
    computed: {
      ...
      localSemester: {
        ...
        set(value) {
          ...
          this.$store.commit("tahfidznilai/setState", { key: "selectedSemester", value: value });
