  ...
  <div>
    <div class="container-transaction">
      <div class="list-transaction mb-2" v-for="(group, index) in groupedTransactions" :key="index">
        ...
        <div class="card p-3 shadow" style="border-radius: 15px;" :class="isLastKey(index) ? 'mb-5' : ''">
          <div class="list-transaction-detail d-flex justify-content-between" v-for="(data, i) in group" :key="i">
            <!-- :class="group.length > 1 ? 'mb-3' : ''" -->
