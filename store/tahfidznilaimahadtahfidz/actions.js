...
export default {
  async changeUnit({ commit, state, dispatch, rootState }) {
    ...
    try {
      ...
      const data = await this.$apiBase.$get(
        `get-settings?program=${program}&type=nilaiqurantahfidz&hlq=${halaqah}&smstr=${state.selectedSemester}&label=${label}`,
      );
  ...
  async getByKelas({ commit, state, dispatch, rootState }) {
    ...
    try {
      const data = await this.$apiBase.$get(`get-settings?program=${program}&type=nilaiqurantahfidz&kls=${kelas}&smstr=${semester}&label=${label}`);
  ...
  async getByHalaqah({ commit, state, dispatch, rootState }) {
    ...
    try {
      const data = await this.$apiBase.$get(`get-settings?program=${program}&type=nilaiqurantahfidz&hlq=${halaqah}&smstr=${semester}&label=${label}`);
      commit("setState", { key: "selectedQuran", value: data.quran });
  ...
  async getSantri({ commit, state, dispatch, rootState }) {
    ...
    try {
      const settingData = await this.$apiBase.$get(
        `get-settings?program=${program}&type=nilaiqurantahfidz&hlq=${rawHalaqah}&smstr=${datas["Semester"]}&label=${label}`,
      );
