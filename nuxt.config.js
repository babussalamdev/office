...
export default {
  ...
  components: {
    dirs: [
      ...
      "~/components/menu",
      "~/components/laporan",
      "~/components/kebersihan",
      "~/components/asrama",
      "~/components/ekskull",
      "~/components/ekskull/absensi",
      "~/components/ekskull/jurnal",
      "~/components/ekskull/nilai",
      "~/components/ekskull/rekap",
      "~/components/pengampu",
      "~/components/pengampu/absensi",
      "~/components/kelas",
      "~/components/kelas/nilai",
      "~/components/kelas/jurnal",
      "~/components/kelas/jurnalmatan",
      ...
      "~/components/pegawai/halaqahIdhofi",
      ...
      "~/components/report/tahfidz/tilawah",
